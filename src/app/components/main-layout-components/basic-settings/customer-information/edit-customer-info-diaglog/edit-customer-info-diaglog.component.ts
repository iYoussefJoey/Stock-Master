...
@Component({
  selector: 'app-edit-customer-info-diaglog',
  standalone: true,
  imports: [MiniforminputComponent,MatDialogModule,ReactiveFormsModule,MatButtonModule],
  templateUrl: './edit-customer-info-diaglog.component.html',
  styleUrl: './edit-customer-info-diaglog.component.scss'
})
export class EditCustomerInfoDiaglogComponent {
