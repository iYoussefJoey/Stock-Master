...
@Component({
  selector: 'app-add-dialog-supp-info',
  standalone: true,
  imports: [
    MatFormFieldModule,
    MatInputModule,
  ...
  templateUrl: './add-dialog-supp-info.component.html',
  styleUrl: './add-dialog-supp-info.component.scss',
})
export class AddDialogSuppInfoComponent {
